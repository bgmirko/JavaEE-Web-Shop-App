...
public class ShoppingCart {
     ...
     */
    public synchronized void addItem(Artikli product) {
     ...
     * @see ShoppingCartItem
     */
    public synchronized void update(Artikli product, String quantity) {
    ...
    public synchronized double getSubtotal() {
        ...
        for (ShoppingCartItem scItem : items) {
            ...
            Artikli product = (Artikli) scItem.getProduct();
            amount += (scItem.getQuantity() * product.getCena().doubleValue());
        }
